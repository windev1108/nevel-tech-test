...
interface CarouselWithControlsProps {
    title: string;
    items: ProductImage[];
    renderItem: (item: ProductImage) => React.ReactNode;
    className?: string;
...
const CarouselWithControls: React.FC<CarouselWithControlsProps> = ({
    title,
    items,
    renderItem,
    className = '',
    ...
    return (
        <div className={className}>
            <div className="flex items-center justify-between mb-4">
                <h2 className={`font-bold text-primary uppercase ${titleClassName}`}>
                    {title}
                </h2>
